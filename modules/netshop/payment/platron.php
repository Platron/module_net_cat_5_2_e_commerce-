...
class Payment_platron {
    ...
    function create_bill($to_string = false) {		
		...
		$arrFields = array(
			...
			'pg_currency'		=> $this->shop->Currencies[$this->shop->DefaultCurrencyID],
        ...
        $strPaymentForm = "<form id='fplatron' target='_blank' action='https://platron.ru/payment.php' method='POST' >";
